...
import org.foi.nwtis.mvukasovi.konfiguracije.KonfiguracijaBin;
import org.foi.nwtis.mvukasovi.konfiguracije.KonfiguracijaJson;
import org.foi.nwtis.mvukasovi.konfiguracije.KonfiguracijaTxt;
import org.foi.nwtis.mvukasovi.konfiguracije.KonfiguracijaXml;
import org.foi.nwtis.mvukasovi.konfiguracije.KonfiguracijaYaml;
...
public abstract class KonfiguracijaApstraktna implements Konfiguracija {
   ...
   * Daj sve postavke.
   *
   * @return Objekt klase Properties --to su postavke
   */
  @Override
   ...
   * @return true, ako ne postoji postavka, inače false
   */
  @Override
   ...
   *
   * @param kljuc Ključ postavke
   * @param vrijednost Vrijednost posta
